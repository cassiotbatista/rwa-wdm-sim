...
class Population(object):
    ...
    def make_chromosome(self, mat: np.ndarray,
        ...
        2. Randomly choose, with equal probability, one of the nodes that is
           *surely* connected to the current node to be the next in path
        3. If the chosen node hasn't been visited before, mark it as the next
           in the path (gene). Otherwise find another node
