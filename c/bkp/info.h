...
/* NSF Parameters */
/* ************** */
#define NSF_SOURCE_NODE   0     // source
#define NSF_DEST_NODE     12    // destination node
#define NSF_NUM_NODES     14    // number of nodes on NSF network

#define NSF_NUM_CHANNELS  16    // total number of wavelengths available
#define NSF_CHANNEL_FREE  0     // init all link wavelengths available at once?

/* **************************** */
/* Genetic Algorithm Parameters */
/* **************************** */
#define GA_SIZE_POP       30    // size of the population of each species

#define GA_MIN_GEN        25    // min number of generations
